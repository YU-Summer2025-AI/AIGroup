...
# TRAITS MODEL
learn_traits = load_learner('female_model_traits.pkl')
...
joblib.dump((shap_values_traits, X_small_traits), "shap_female_traits.pkl")

# RELIGION MODEL ANALYSIS
learn_religion = load_learner('female_model_religion.pkl')
...
joblib.dump((shap_values_religion, X_small_religion), "shap_female_religion.pkl")
