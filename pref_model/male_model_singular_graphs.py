...
trait_y_names = [
    ...
    'avg_age',]
# traits model
shap_values_traits, X_traits = joblib.load("shap_male_traits.pkl")
...
for i, idx in enumerate(indices):
    ...
    trait_member_id = df.iloc[idx]["male_id"]
    ax.set_title(f"Trait Model: ID {trait_member_id}", fontsize=12)
...
shap_values_religion, X_religion = joblib.load("shap_male_religion.pkl")
...
for i, idx in enumerate(indices):
    ...
    ax.tick_params(axis='y', labelsize=6)
    religion_member_id = df.iloc[idx]["male_id"]
